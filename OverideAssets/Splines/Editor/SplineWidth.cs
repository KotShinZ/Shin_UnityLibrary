...
[EditorTool("Width Tool", typeof(SplineCreater))]
public class WidthTool : SplineToolBase<float>, IDrawSelectedHandles
{
    ...
    {
        var splineDataTarget = target as SplineCreater;
